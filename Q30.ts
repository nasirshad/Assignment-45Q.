...
let current_users: String[] = ["Shoaib Akhtar", "Zaman Khan", "jeena", "stylo", "batista"]
let new_users: String[] = ["saqi", "Wasi", "vijy", "Jamshaid", "Kojy", "Stylo"]

function arraysAreEqual1(arry1: any[], arry2: any[]): any {
